...
SinXmlHighlighter::SinXmlHighlighter(QObject * parent) :
...
SinXmlHighlighter::SinXmlHighlighter(QTextDocument * parent) :
QSyntaxHighlighter(parent)
{
	setRegexes();
	setFormats();
...
SinXmlHighlighter::SinXmlHighlighter(QTextEdit * parent) :
QSyntaxHighlighter(parent)
{
	setRegexes();
	setFormats();
...
void SinXmlHighlighter::highlightBlock(const QString & text)
{
...
void SinXmlHighlighter::highlightByRegex(const QTextCharFormat & format,
...
void SinXmlHighlighter::setRegexes()
{
...
void SinXmlHighlighter::setFormats()
{
